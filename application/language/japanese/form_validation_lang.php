...
// 追加分メッセージ
$lang['form_validation_valid_lasta_email'] = 'メールアドレスの入力形式が誤っています';
$lang['form_validation_authentication_failed'] = 'メールアドレスもしくはパスワードに誤りがあります';
$lang['form_validation_unique_email'] = '既に登録されているメールアドレスです。';
$lang['form_validation_valid_lasta_password'] = '{field}欄は半角英数・記号、8〜20文字で入力してください';
$lang['form_validation_valid_numvalue'] = '{field}欄は正の数値で指定してください';
$lang['csrf_token_error'] = '既に情報が更新されています。お手数ですが、入力内容をご確認のうえ再度実行してください。';
